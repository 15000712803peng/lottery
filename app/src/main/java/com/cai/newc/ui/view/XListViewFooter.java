...
public class XListViewFooter extends LinearLayout {
	...
	public void noMore(boolean prompt){
		if(prompt){
			mHintView.setVisibility(View.VISIBLE);
...
//		foot_arrow.setVisibility(View.GONE);
	...
	private void initView(Context context) {
		...
		historyText = (ImageView) moreView.findViewById(R.id.text_order_history);
...
//		mRotateDownAnim.setFillAfter(true);
	...
	public void showHistory(int text){
//		mContentView.setVisibility(View.GONE);
		historyText.setVisibility(View.VISIBLE);
//		historyText.setText(text);
	...
	public void showHistoryText(){
		...
		historyText.setVisibility(View.VISIBLE);
		//historyText.setText(text);
//		historyText.setText(Html.fromHtml("没有更多优惠券<br /><br /><br /><font color='#20B1D9'>去查看已过期的优惠券</font>"));
