...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabTextColor = 0xFFdddede;
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawRect(lineLeft + 10, height - indicatorHeight, lineRight - 10, height,
				rectPaint);
...
//			canvas.drawLine(tab.getRight(), dividerPadding, tab.getRight()-100,
